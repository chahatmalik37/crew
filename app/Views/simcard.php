...
<div class="container">
    ...
    <!-- Email Entry -->
    <form action="<?php echo base_url('SimCard/store'); ?>" method="post"> 
    <div class="row justify-content-center">
    <div class="col">
       ...
       <div class="row justify-content-center">
            <div class="col-3">
                <div class="form-group">
                        ...
                        <div><input type="text" name="simno" id="simno" value="<?php echo set_value('simno'); ?>" class="form-control"></div><span class="text-danger"> <?= displayError($validation, 'simno') ?></span>  
                </div>
            </div>
            <div class="col-3">
                <div class="form-group">
                        <label class="fw-semibold">Service Provider<span class="text-danger">*</span></label>
                        <div><input type="text" name="provider" id="provider" value="<?php echo set_value('provider'); ?>" class="form-control" maxlength=""></div><span class="text-danger"> <?= displayError($validation, 'provider') ?></span> 
                </div>
            </div>
            <div class="col-3">
                <div class="form-group">
                        <label class="fw-semibold">Package<span class="text-danger">*</span></label>
                        <div><input type="text" name="package" id="package" value="<?php echo set_value('package'); ?>" class="form-control" maxlength=""></div><span class="text-danger"><?= displayError($validation, 'package') ?></span>              
                </div>
           </div>
        ...
        {$i=1;
           ...
           ?>">
                    ...
                    <?php if($sim['status'] == 'Active'){?>
                            <a href="<?php echo base_url('SimCard/delete').'/'.$sim['id'];?>"> <i class="fas fa-trash-alt"></i></a><?php }
                            else{ ?>
