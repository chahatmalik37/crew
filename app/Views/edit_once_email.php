...
<div class="container">
    ...
    <!-- Email Entry -->
    <form method="post" action="<?= base_url('OnceEmail/update/' . $row['id']); ?>">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-3">
                            <div class="form-group">
                                ...
                                <div><input type="text" name="email" value="<?php echo $row['email_id']; ?>" class="form-control"><span class="text-danger"><?= displayError($validation, 'email') ?><span></div>
                        ...
                        <div class="col-3">
                            <div class="form-group">
                                ...
                                <div><input type="text" name="natureofmail" value="<?php echo $row['nature_of_email']; ?>" class="form-control" maxlength=""><span class="text-danger"><?= displayError($validation, 'natureofmail') ?><span></div>
                        ...
                        <div class="col-3">
                            <div class="form-group">
                                ...
                                <div><input type="date" name="expiry" value="<?php echo $row['expiry_date'];; ?>" class="form-control" maxlength=""></div>
                            </div>
                        </div>
                        ...
                        <div class="col-3">
                            <div class="form-group">
                                ...
                                <div><input type="text" name="forwarding" value="<?php echo $row['forwarding_to'];; ?>" class="form-control" maxlength=""></div>
                            </div>
                        </div>
        ...
        <table class="table table-striped table-sm " data-toggle="table" data-search="true" data-pagination="true" data-page-list="[10, 25, 50, 100, all]" data-show-export="true" data-icons-prefix="fa" data-icons="icons" data-buttons-class="primary">
           ...
           ?>">
                        ...
                        <?php if($emailData['status'] == 'Active'){?>
                            <a href="<?php echo base_url('OnceEmail/delete') . '/' . $emailData['id']; ?>"> <i class="fas fa-trash-alt"></i></a>
                            <?php }
                            else{ ?>
