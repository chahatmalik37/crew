...
<div class="container">
    ...
    <!--Antivirus -->
   <form method="post" action="<?= base_url('OnceAntivirus/update/' . $row['id']); ?>">
       ...
       <div class="row justify-content-center">
            <div class="col-3">
                <div class="form-group">
                       ...
                       <input type="text" name="provider" id="provider" value="<?= $row['serv_provider']?>" class="form-control" maxlength="">
            ...
            <div class="col-3">
                <div class="form-group">
                        ...
                        <input type="text" name="keys" id="keys"  value="<?= $row['key_alloted']?>" class="form-control" maxlength=""> 
                        <span class="text-danger"><?= displayError($validation, 'keys') ?></span> 
                </div>
            </div>
            <div class="col-3">
                <div class="form-group">
                        <label class="fw-semibold">Expiry Date</label>
                        <input type="date"  name="expirydate" id="expirydate" value="<?= $row['expiry_date']?>" class="form-control">
                </div>
            </div>
